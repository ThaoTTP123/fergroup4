...
export default function ShopItem({ product, openFilter }) {
  ...
  return (
    <div
      className="md:static md:z-0 p-5 py-10 bg-purple-50 text-center transform duration-500 hover:-translate-y-2 cursor-pointer"
      style={{
        position: openFilter ? 'relative' : 'static',
        zIndex: openFilter ? -1 : 0,
      }}
    >
      <img className="w-full" src={product.image_url} />
